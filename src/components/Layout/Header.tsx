...
const Header: React.FC<HeaderProps> = ({ onMenuClick }) => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
      {/* Logo e Botões de Menu */}
      <div className="flex items-center gap-2">
        {/* Logo */}
        <div className="flex items-center justify-center">
          <img src={logo} alt="Clerky" className="h-10 w-auto" />
        </div>
