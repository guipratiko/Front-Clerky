    ...
    <>
      ...
      <aside
        className={`
          ...
          ${isCollapsed ? 'w-16 lg:w-16' : 'w-64'} bg-white dark:bg-gray-800 shadow-lg
          ...
          <div className="p-2 border-t border-gray-200 dark:border-gray-700 space-y-2">
            ...
            <div className="flex flex-col gap-2">
              <button
                ...
                className="w-full flex items-center justify-center p-2 rounded-lg bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 text-clerky-backendText dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 transition-smooth"
