...
export const DelayNode: React.FC<NodeProps> = ({ data, selected }) => {
  ...
  const formatDelay = () => {
    if (delay === 0) return t('mindClerky.nodeSettings.delayValue');
    const unitMap = {
      seconds: t('mindClerky.nodeSettings.delaySeconds'),
      minutes: t('mindClerky.nodeSettings.delayMinutes'),
      hours: t('mindClerky.nodeSettings.delayHours'),
    };
