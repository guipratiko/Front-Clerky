...
const ContactCard: React.FC<ContactCardProps> = ({ contact, onClick }) => {
  ...
  return (
    <div
      ...
      {...listeners}
      onClick={onClick}
      className="bg-white dark:bg-gray-800 rounded-lg p-4 mb-3 cursor-grab active:cursor-grabbing hover:shadow-md transition-shadow duration-150 border border-gray-200 dark:border-gray-700 relative overflow-hidden"
    >
      ...
      >
        <div className="flex flex-col h-[582px]">
          ...
          <div 
            ...
            className="flex-1 overflow-y-auto p-4 bg-gray-50 dark:bg-gray-800 rounded-lg mb-4 min-h-0"
          >
          {isLoading ? (
          ...
          {showCaptionInput && selectedFile && (
            <div className="flex items-center gap-2 p-2 bg-gray-100 dark:bg-gray-700 rounded-lg">
              ...
              <input
                ...
                className="flex-1 px-3 py-1 text-sm border border-gray-300 dark:border-gray-600 rounded focus:ring-2 focus:ring-clerky-backendButton focus:border-transparent bg-white dark:bg-gray-800 text-clerky-backendText dark:text-gray-200"
                onKeyPress={(e) => {
                  if (e.key === 'Enter') {
                    e.preventDefault();
                    handleSendMedia();
      ...
      <div className="animate-fadeIn">
        ...
        {!selectedInstanceId ? (
          ...
          >
            ...
            <DragOverlay>
              {draggedContact ? (
                <div className="bg-white dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700 shadow-lg opacity-90 w-[222px]">
