...
{`{
  ...
  "statusCode": 400
        ...
        <Card padding="lg" shadow="lg" className="mb-6">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            {t('documentation.groupManagementDescription')}
          </p>

          {/* Listar Grupos */}
          <div className="mb-6">
            <h3 className="text-xl font-semibold text-clerky-backendText dark:text-gray-200 mb-3">
              {t('documentation.listGroups')}
            </h3>
            <p className="text-gray-600 dark:text-gray-400 mb-3">
              <code className="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded">GET /api/groups</code>
            </p>
            <p className="text-sm text-gray-500 dark:text-gray-500 mb-3">
              {t('documentation.listGroupsDescription')}
            </p>
            <div className="mb-3">
              <p className="text-sm font-medium text-clerky-backendText dark:text-gray-200 mb-2">{t('documentation.queryParameters')}</p>
              <ul className="list-disc list-inside text-sm text-gray-600 dark:text-gray-400 space-y-1 ml-4">
                <li><code className="bg-gray-100 dark:bg-gray-800 px-1 py-0.5 rounded">instanceId</code> {t('documentation.instanceIdParam')}</li>
              </ul>
            </div>
            <CodeBlock
              code={`curl -X GET "${API_BASE_URL}/api/groups?instanceId=SEU_INSTANCE_ID" \\
  -H "Authorization: Bearer SEU_TOKEN_AQUI" \\
  -H "Content-Type: application/json"`}
              language="bash"
              id="list-groups"
...
{`{
  ...
  "count": 1
          ...
          <div className="mb-6">
            <h3 className="text-xl font-semibold text-clerky-backendText dark:text-gray-200 mb-3">
              {t('documentation.createGroup')}
            </h3>
            <p className="text-gray-600 dark:text-gray-400 mb-3">
              <code className="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded">POST /api/groups/create</code>
            </p>
            <p className="text-sm text-gray-500 dark:text-gray-500 mb-3">
              {t('documentation.createGroupDescription')}
            </p>
            <div className="mb-3">
              <p className="text-sm font-medium text-clerky-backendText dark:text-gray-200 mb-2">{t('documentation.parameters')}</p>
              <ul className="list-disc list-inside text-sm text-gray-600 dark:text-gray-400 space-y-1 ml-4">
                <li><code className="bg-gray-100 dark:bg-gray-800 px-1 py-0.5 rounded">instanceId</code> {t('documentation.instanceIdParam')}</li>
                <li><code className="bg-gray-100 dark:bg-gray-800 px-1 py-0.5 rounded">subject</code> {t('documentation.groupNameParam')}</li>
                <li><code className="bg-gray-100 dark:bg-gray-800 px-1 py-0.5 rounded">description</code> {t('documentation.groupDescriptionParam')}</li>
                <li><code className="bg-gray-100 dark:bg-gray-800 px-1 py-0.5 rounded">participants</code> {t('documentation.participantsParam')}</li>
              </ul>
            </div>
            <CodeBlock
              code={`curl -X POST ${API_BASE_URL}/api/groups/create \\
  -H "Authorization: Bearer SEU_TOKEN_AQUI" \\
  -H "Content-Type: application/json" \\
  -d '{
    ...
    "participants": [
      ...
      "5511888888888"
          ...
          <div className="mb-6">
            <h3 className="text-xl font-semibold text-clerky-backendText dark:text-gray-200 mb-3">
              {t('documentation.validateParticipants')}
            </h3>
            <p className="text-gray-600 dark:text-gray-400 mb-3">
              <code className="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded">POST /api/groups/validate-participants</code>
            </p>
            <p className="text-sm text-gray-500 dark:text-gray-500 mb-3">
              {t('documentation.validateParticipantsDescription')}
            </p>
            <div className="mb-3">
              <p className="text-sm font-medium text-clerky-backendText dark:text-gray-200 mb-2">{t('documentation.parameters')}</p>
              <ul className="list-disc list-inside text-sm text-gray-600 dark:text-gray-400 space-y-1 ml-4">
            ...
            <CodeBlock
              code={`curl -X POST ${API_BASE_URL}/api/groups/validate-participants \\
  -H "Authorization: Bearer SEU_TOKEN_AQUI" \\
  -H "Content-Type: application/json" \\
  -d '{
    "instanceId": "SEU_INSTANCE_ID",
...
{`{
  ...
  "invalid": [
    { "phone": "5511888888888", "reason": "Número não possui WhatsApp" }
  ]
}`}
              </pre>
            </div>
          ...
          <div className="mb-6">
            <h3 className="text-xl font-semibold text-clerky-backendText dark:text-gray-200 mb-3">
              {t('documentation.updateGroupSubject')}
            </h3>
            <p className="text-gray-600 dark:text-gray-400 mb-3">
              <code className="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded">POST /api/groups/update-subject</code>
            </p>
            <p className="text-sm text-gray-500 dark:text-gray-500 mb-3">
              {t('documentation.updateGroupSubjectDescription')}
            </p>
            <div className="mb-3">
              <p className="text-sm font-medium text-clerky-backendText dark:text-gray-200 mb-2">{t('documentation.parameters')}</p>
              <ul className="list-disc list-inside text-sm text-gray-600 dark:text-gray-400 space-y-1 ml-4">
                <li><code className="bg-gray-100 dark:bg-gray-800 px-1 py-0.5 rounded">instanceId</code> {t('documentation.instanceIdParam')}</li>
                <li><code className="bg-gray-100 dark:bg-gray-800 px-1 py-0.5 rounded">groupId</code> {t('documentation.groupIdParam')}</li>
                <li><code className="bg-gray-100 dark:bg-gray-800 px-1 py-0.5 rounded">subject</code> {t('documentation.groupNameParam')}</li>
              </ul>
            </div>
            <CodeBlock
              code={`curl -X POST ${API_BASE_URL}/api/groups/update-subject \\
  -H "Authorization: Bearer SEU_TOKEN_AQUI" \\
  -H "Content-Type: application/json" \\
  -d '{
    "instanceId": "SEU_INSTANCE_ID",
    "groupId": "120363403408943696@g.us",
    "subject": "Novo Nome do Grupo"
          ...
          <div className="mb-6">
            <h3 className="text-xl font-semibold text-clerky-backendText dark:text-gray-200 mb-3">
              {t('documentation.updateGroupDescription')}
            </h3>
            <p className="text-gray-600 dark:text-gray-400 mb-3">
              <code className="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded">POST /api/groups/update-description</code>
            </p>
            <p className="text-sm text-gray-500 dark:text-gray-500 mb-3">
              {t('documentation.updateGroupDescriptionDescription')}
            </p>
            <div className="mb-3">
              <p className="text-sm font-medium text-clerky-backendText dark:text-gray-200 mb-2">{t('documentation.parameters')}</p>
              <ul className="list-disc list-inside text-sm text-gray-600 dark:text-gray-400 space-y-1 ml-4">
            ...
            <CodeBlock
              code={`curl -X POST ${API_BASE_URL}/api/groups/update-description \\
  -H "Authorization: Bearer SEU_TOKEN_AQUI" \\
  -H "Content-Type: application/json" \\
  -d '{
    "instanceId": "SEU_INSTANCE_ID",
    ...
    "description": "Nova descrição do grupo"
          ...
          <div className="mb-6">
            <h3 className="text-xl font-semibold text-clerky-backendText dark:text-gray-200 mb-3">
              {t('documentation.updateGroupPicture')}
            </h3>
            <p className="text-gray-600 dark:text-gray-400 mb-3">
              <code className="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded">POST /api/groups/update-picture</code>
            </p>
            <p className="text-sm text-gray-500 dark:text-gray-500 mb-3">
              {t('documentation.updateGroupPictureDescription')}
            </p>
            <div className="mb-3">
              <p className="text-sm font-medium text-clerky-backendText dark:text-gray-200 mb-2">{t('documentation.parameters')}</p>
              <ul className="list-disc list-inside text-sm text-gray-600 dark:text-gray-400 space-y-1 ml-4">
                <li><code className="bg-gray-100 dark:bg-gray-800 px-1 py-0.5 rounded">instanceId</code> {t('documentation.instanceIdParam')}</li>
                <li><code className="bg-gray-100 dark:bg-gray-800 px-1 py-0.5 rounded">groupId</code> {t('documentation.groupIdParam')}</li>
                <li><code className="bg-gray-100 dark:bg-gray-800 px-1 py-0.5 rounded">image</code> {t('documentation.groupImageParam')}</li>
              </ul>
            </div>
            <CodeBlock
              code={`curl -X POST ${API_BASE_URL}/api/groups/update-picture \\
  -H "Authorization: Bearer SEU_TOKEN_AQUI" \\
  -F "instanceId=SEU_INSTANCE_ID" \\
  -F "groupId=120363403408943696@g.us" \\
  -F "image=@/caminho/para/imagem.jpg"`}
          ...
          <div className="mb-6">
            <h3 className="text-xl font-semibold text-clerky-backendText dark:text-gray-200 mb-3">
              {t('documentation.updateGroupSettings')}
            </h3>
            <p className="text-gray-600 dark:text-gray-400 mb-3">
              <code className="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded">POST /api/groups/update-settings</code>
            </p>
            <p className="text-sm text-gray-500 dark:text-gray-500 mb-3">
              {t('documentation.updateGroupSettingsDescription')}
            </p>
            <div className="mb-3">
              <p className="text-sm font-medium text-clerky-backendText dark:text-gray-200 mb-2">{t('documentation.parameters')}</p>
              <ul className="list-disc list-inside text-sm text-gray-600 dark:text-gray-400 space-y-1 ml-4">
                <li><code className="bg-gray-100 dark:bg-gray-800 px-1 py-0.5 rounded">instanceId</code> {t('documentation.instanceIdParam')}</li>
                <li><code className="bg-gray-100 dark:bg-gray-800 px-1 py-0.5 rounded">groupId</code> {t('documentation.groupIdParam')}</li>
                <li><code className="bg-gray-100 dark:bg-gray-800 px-1 py-0.5 rounded">action</code> {t('documentation.groupActionParam')}</li>
              </ul>
              <p className="text-xs text-gray-500 dark:text-gray-500 mt-2 ml-4">
                💡 {t('documentation.groupActionValues')}
              </p>
            </div>
            <CodeBlock
              code={`curl -X POST ${API_BASE_URL}/api/groups/update-settings \\
  -H "Authorization: Bearer SEU_TOKEN_AQUI" \\
  -H "Content-Type: application/json" \\
  -d '{
    "instanceId": "SEU_INSTANCE_ID",
    ...
    "action": "announcement"
          ...
          <div className="mb-6">
            <h3 className="text-xl font-semibold text-clerky-backendText dark:text-gray-200 mb-3">
              {t('documentation.getInviteCode')}
            </h3>
            <p className="text-gray-600 dark:text-gray-400 mb-3">
              <code className="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded">GET /api/groups/invite-code</code>
            </p>
            <p className="text-sm text-gray-500 dark:text-gray-500 mb-3">
              {t('documentation.getInviteCodeDescription')}
            </p>
            <div className="mb-3">
              <p className="text-sm font-medium text-clerky-backendText dark:text-gray-200 mb-2">{t('documentation.queryParameters')}</p>
              <ul className="list-disc list-inside text-sm text-gray-600 dark:text-gray-400 space-y-1 ml-4">
            ...
            <CodeBlock
              code={`curl -X GET "${API_BASE_URL}/api/groups/invite-code?instanceId=SEU_INSTANCE_ID&groupId=120363403408943696@g.us" \\
  -H "Authorization: Bearer SEU_TOKEN_AQUI" \\
  -H "Content-Type: application/json"`}
              language="bash"
              id="get-invite-code"
...
{`{
  ...
  "url": "https://chat.whatsapp.com/ABC123XYZ"
          ...
          <div className="mb-6">
            <h3 className="text-xl font-semibold text-clerky-backendText dark:text-gray-200 mb-3">
              {t('documentation.mentionEveryone')}
            </h3>
            <p className="text-gray-600 dark:text-gray-400 mb-3">
              <code className="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded">POST /api/groups/mention-everyone</code>
            </p>
            <p className="text-sm text-gray-500 dark:text-gray-500 mb-3">
              {t('documentation.mentionEveryoneDescription')}
            </p>
            <div className="mb-3">
              <p className="text-sm font-medium text-clerky-backendText dark:text-gray-200 mb-2">{t('documentation.parameters')}</p>
              <ul className="list-disc list-inside text-sm text-gray-600 dark:text-gray-400 space-y-1 ml-4">
                <li><code className="bg-gray-100 dark:bg-gray-800 px-1 py-0.5 rounded">instanceId</code> {t('documentation.instanceIdParam')}</li>
                <li><code className="bg-gray-100 dark:bg-gray-800 px-1 py-0.5 rounded">groupId</code> {t('documentation.groupIdParam')}</li>
                <li><code className="bg-gray-100 dark:bg-gray-800 px-1 py-0.5 rounded">text</code> {t('documentation.messageTextParam')}</li>
              </ul>
            </div>
            <CodeBlock
              code={`curl -X POST ${API_BASE_URL}/api/groups/mention-everyone \\
  -H "Authorization: Bearer SEU_TOKEN_AQUI" \\
  -H "Content-Type: application/json" \\
  -d '{
    "instanceId": "SEU_INSTANCE_ID",
    "groupId": "120363403408943696@g.us",
    "text": "Olá a todos! Esta mensagem menciona todos os participantes."
  }'`}
              language="bash"
              id="mention-everyone"
            />
          ...
          <div className="mb-6">
            <h3 className="text-xl font-semibold text-clerky-backendText dark:text-gray-200 mb-3">
              {t('documentation.leaveGroup')}
            </h3>
            <p className="text-gray-600 dark:text-gray-400 mb-3">
              <code className="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded">POST /api/groups/leave</code>
            </p>
            <p className="text-sm text-gray-500 dark:text-gray-500 mb-3">
              {t('documentation.leaveGroupDescription')}
            </p>
            <div className="mb-3">
              <p className="text-sm font-medium text-clerky-backendText dark:text-gray-200 mb-2">{t('documentation.parameters')}</p>
              <ul className="list-disc list-inside text-sm text-gray-600 dark:text-gray-400 space-y-1 ml-4">
            ...
            <CodeBlock
              code={`curl -X POST ${API_BASE_URL}/api/groups/leave \\
  -H "Authorization: Bearer SEU_TOKEN_AQUI" \\
  -H "Content-Type: application/json" \\
  -d '{
    "instanceId": "SEU_INSTANCE_ID",
